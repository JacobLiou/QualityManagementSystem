        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GenerateType = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true, comment: "生成方式")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DatabaseName = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true, comment: "数据库名")
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColumnKey = table.Column<string>(type: "varchar(5)", maxLength: 5, nullable: true, comment: "主键")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DataType = table.Column<string>(type: "varchar(128)", maxLength: 128, nullable: true, comment: "数据库中类型")
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OldValue = table.Column<string>(type: "longtext", nullable: true, comment: "旧值")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreatedTime = table.Column<DateTime>(type: "datetime(6)", nullable: true, comment: "操作时间"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParamsObj = table.Column<string>(type: "longtext", nullable: true, comment: "参数对象")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ExceptionTime = table.Column<DateTime>(type: "datetime(6)", nullable: true, comment: "异常时间"),
                    TenantId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OpTime = table.Column<DateTime>(type: "datetime(6)", nullable: true, comment: "操作时间"),
                    Account = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true, comment: "操作人")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TenantId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci")
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisTime = table.Column<DateTime>(type: "datetime(6)", nullable: true, comment: "访问时间"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublicOrgName = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true, comment: "发布机构名称")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PublicTime = table.Column<DateTime>(type: "datetime(6)", nullable: true, comment: "发布时间"),
                    CancelTime = table.Column<DateTime>(type: "datetime(6)", nullable: true, comment: "撤回时间"),
                    Status = table.Column<int>(type: "int", nullable: false, comment: "状态"),
                    CreatedTime = table.Column<DateTime>(type: "datetime(6)", nullable: true, comment: "创建时间"),
                    UpdatedTime = table.Column<DateTime>(type: "datetime(6)", nullable: true, comment: "更新时间"),
                    CreatedUserId = table.Column<long>(type: "bigint", nullable: true, comment: "创建者Id"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 142307070910551L, "superAdmin", 1, null, new DateTime(1986, 7, 26, 0, 0, 0, 0, DateTimeKind.Local), null, null, null, null, false, null, null, "超级管理员", "superAdmin", "e10adc3949ba59abbe56e057f20f883e", "18020030720", 1, 0, null, 142307070918780L, null, null, null },
                    { 142307070910552L, "admin", 2, null, new DateTime(1986, 7, 26, 0, 0, 0, 0, DateTimeKind.Local), null, null, null, null, false, null, null, "系统管理员", "admin", "e10adc3949ba59abbe56e057f20f883e", "18020030720", 1, 0, null, 142307070918780L, null, null, null },
                    { 142307070910553L, "zuohuaijun", 3, null, new DateTime(1986, 7, 26, 0, 0, 0, 0, DateTimeKind.Local), null, null, null, null, false, null, null, "普通用户", "zuohuaijun", "e10adc3949ba59abbe56e057f20f883e", "18020030720", 1, 0, null, 142307070918780L, null, null, null },
                    { 142307070910554L, "zuohuaijun@163.com", 2, null, new DateTime(1986, 7, 26, 0, 0, 0, 0, DateTimeKind.Local), null, null, null, null, false, null, null, "系统管理员", "admin", "e10adc3949ba59abbe56e057f20f883e", "18020030720", 1, 0, null, 142307070918781L, null, null, null },
                    { 142307070910556L, "dilon@163.com", 3, null, new DateTime(1986, 7, 26, 0, 0, 0, 0, DateTimeKind.Local), null, null, null, null, false, null, null, "普通用户", "dilon", "e10adc3949ba59abbe56e057f20f883e", "18020030720", 1, 0, null, 142307070918781L, null, null, null }
                });
