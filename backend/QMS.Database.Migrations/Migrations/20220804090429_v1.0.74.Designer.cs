...
namespace QMS.Database.Migrations.Migrations.DefaultDb
{
    ...
    [Migration("20220804090429_v1.0.74")]
    partial class v1074
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.Entity.Common.MonitorCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("qms_monitor_code");

                    b.HasComment("上位机注册码");
                });

            modelBuilder.Entity("Furion.Extras.Admin.NET.Entity.Common.MonitorUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("qms_monitor_user");

                    b.HasComment("上位机用户");
                });

            modelBuilder.Entity("Furion.Extras.Admin.NET.Entity.Common.SsuGroup", b =>
                {
                    b.Property<long>("Id")
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.Entity.Common.SsuGroupUser", b =>
                {
                    ...
                    b.ToTable("ssu_group_user");

                    b.HasComment("人员组成员关联表");
                });

            modelBuilder.Entity("Furion.Extras.Admin.NET.Entity.Common.SsuProduct", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasComment("Id主键");
                    ...
                    b.ToTable("ssu_product");

                    b.HasComment("产品表");
                });

            modelBuilder.Entity("Furion.Extras.Admin.NET.Entity.Common.SsuProductUser", b =>
                {
                    ...
                    b.HasKey("ProductId", "EmployeeId");

                    b.HasIndex("EmployeeId");

                    b.ToTable("ssu_product_user");

                    b.HasComment("产品人员关联表");
                });

            modelBuilder.Entity("Furion.Extras.Admin.NET.Entity.Common.SsuProject", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasComment("Id主键");
                    ...
                    b.ToTable("ssu_project");

                    b.HasComment("项目表");
                });

            modelBuilder.Entity("Furion.Extras.Admin.NET.Entity.Common.SsuProjectProduct", b =>
                {
                    ...
                    b.ToTable("ssu_project_product");

                    b.HasComment("项目产品关联表");
                });

            modelBuilder.Entity("Furion.Extras.Admin.NET.Entity.Common.SsuProjectUser", b =>
                {
                    b.Property<long>("ProjectId")
                        .HasColumnType("bigint")
                        .HasComment("项目编号");
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.SysUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Account = "superAdmin",
                            AdminType = 1,
                            Birthday = new DateTime(1986, 7, 26, 0, 0, 0, 0, DateTimeKind.Local),
                            IsDeleted = false,
                            Name = "超级管理员",
                            NickName = "superAdmin",
            ...
            modelBuilder.Entity("QMS.Core.Entity.SysLogDebug", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DebugContext")
                        .HasColumnType("longtext");

                    b.Property<string>("DebugName")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.Entity.Common.SsuGroupUser", b =>
                {
                    b.HasOne("Furion.Extras.Admin.NET.SysEmp", "Employee")
                        .WithMany("SsuGroupUsers")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Furion.Extras.Admin.NET.Entity.Common.SsuGroup", "Group")
                        .WithMany("SsuGroupUsers")
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.Entity.Common.SsuProductUser", b =>
                {
                    b.HasOne("Furion.Extras.Admin.NET.SysEmp", "Employee")
                        .WithMany("SsuProductUsers")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Furion.Extras.Admin.NET.Entity.Common.SsuProduct", "Product")
                        .WithMany("SsuProductUsers")
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.Entity.Common.SsuProjectProduct", b =>
                {
                    b.HasOne("Furion.Extras.Admin.NET.Entity.Common.SsuProduct", "Product")
                        .WithMany("SsuProjectsProducts")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Furion.Extras.Admin.NET.Entity.Common.SsuProject", "Project")
                        .WithMany("SsuProjectsProducts")
            ...
            modelBuilder.Entity("Furion.Extras.Admin.NET.Entity.Common.SsuGroup", b =>
                {
                    b.Navigation("SsuGroupUsers");
                });

            modelBuilder.Entity("Furion.Extras.Admin.NET.Entity.Common.SsuProduct", b =>
                {
                    b.Navigation("SsuProductUsers");

                    b.Navigation("SsuProjectsProducts");
                });

            modelBuilder.Entity("Furion.Extras.Admin.NET.Entity.Common.SsuProject", b =>
                {
                    b.Navigation("SsuProjectUsers");
